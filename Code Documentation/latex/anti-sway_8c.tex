\doxysection{src/anti-\/sway.c File Reference}
\hypertarget{anti-sway_8c}{}\label{anti-sway_8c}\index{src/anti-\/sway.c@{src/anti-\/sway.c}}
...
static void \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{anti-sway_8c_aec2761f3b6d968de754480d114fd4579}{Anti\+Sway\+Mode\+Thread}} (void \texorpdfstring{$\ast$}{*}resource)
\begin{DoxyCompactList}\small\item\em Runs Anti-\/\+Sway. \end{DoxyCompactList}\item 
static int \mbox{\hyperlink{anti-sway_8c_a37ac767cc33745df6f7e52ff6a6435d1}{Anti\+Sway\+Control\+Law}} (Velocity vel\+\_\+ref, Angle angle\+\_\+input, Velocity vel\+\_\+input, \mbox{\hyperlink{struct_anti_sway_control_scheme}{Anti\+Sway\+Control\+Scheme}} \texorpdfstring{$\ast$}{*}scheme, int(\texorpdfstring{$\ast$}{*}Set\+Voltage)(Voltage voltage))
...
static File\+ID\+\_\+t {\bfseries tuning\+\_\+file} = -\/1
...
static int Anti\+Sway\+Control\+Law (\begin{DoxyParamCaption}\item[{Velocity}]{vel\+\_\+ref}{, }\item[{Angle}]{angle\+\_\+input}{, }\item[{Velocity}]{vel\+\_\+input}{, }\item[{\mbox{\hyperlink{struct_anti_sway_control_scheme}{Anti\+Sway\+Control\+Scheme}} \texorpdfstring{$\ast$}{*}}]{scheme}{, }\item[{int(\texorpdfstring{$\ast$}{*}}]{Set\+Voltage~}{)(Voltage voltage)}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}
