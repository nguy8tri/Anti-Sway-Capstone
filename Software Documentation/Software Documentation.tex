...
\end{tcolorbox}
Since this is true for all the sensors/actuator we use, you'll find these functions that do such things being used in obvious places. Below is the dependency diagram for the \texttt{io} module, which wraps this functionality:
\begin{figure}[H]
    \begin{tikzpicture}
        ...
        \node[terminator] at (7, -3.5) (printf_lcd) {\texttt{printf\_lcd}};
        \node[terminator] at (7, -4.5) (Aio_InitC) {\texttt{Aio\_InitC??}};
        \node[terminator] at (7, -5.5) (conC_Encoder_initialize) {\texttt{conC\_Encoder\_initialize}};
        ...
        \draw[-] (printf_lcd) -- (3.5, -3.5) -- (3.5, -0.5);
        \draw[-] (Aio_InitC) -- (3.5, -4.5) -- (3.5, -3.5);
        \draw[-] (conC_Encoder_initialize) -- (3.5, -5.5) -- (3.5, -4.5);
